...
export const FEATURES: FeaturesType[] = [
	...
	},
	{
		...
		title: 'Блог',
		description:
			'Наш тематический уголок с интересными событиями в мире техники'
	},
	{
		href: ROUTE.SERVICE,
	...
	},
	{
		...
		description: 'Реальные деньги за ненужные электронные комплектующие'
	},
	{
		href: ROUTE.UPGRADING,
		title: 'Обновление парка ПК',
		description: 'Полное или частичное обновление парка организационной техники'
	}
]
